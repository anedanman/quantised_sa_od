...
from modules import Encoder, PosEmbeds, SlotAttention, CoordQuantizer
...
class QuantizedClassifier(pl.LightningModule):
    ...
    """
    def __init__(self, resolution=(128, 128), num_slots=10, num_iters=4, in_channels=3, hidden_size=64, slot_size=64, lr=0.00035, coord_scale=1.):
        super().__init__()
